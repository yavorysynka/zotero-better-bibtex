...
Translator.MarkupParser = (function() {
  ...
  AST = (function() {
    ...
    AST.prototype.re.wordJoiner = "([" + AST.prototype.re.whitespace + "]|--+|[\u2013\u2014\u2E3A\u2E3B])+";
    ...
    AST.prototype.re.lcPrefix = "([" + AST.prototype.re.lcChar + "]" + AST.prototype.re.intrawordPunct + "?)";

    AST.prototype.re.lcPostfix = "(" + AST.prototype.re.intrawordPunct + "?[" + AST.prototype.re.lcChar + "])*";

    AST.prototype.re.char = AST.prototype.re.Lu + AST.prototype.re.lcChar;

    AST.prototype.re.prefix = "([" + AST.prototype.re.char + "]" + AST.prototype.re.intrawordPunct + "?)";

    AST.prototype.re.postfix = "(" + AST.prototype.re.intrawordPunct + "?[" + AST.prototype.re.char + "])*";

    AST.prototype.re.protectedWord = AST.prototype.re.lcPrefix + "*[" + AST.prototype.re.Lu + "]" + AST.prototype.re.postfix;
    ...
    AST.prototype.re.leadingUnprotectedWord = RegExp("^([" + AST.prototype.re.Lu + "][" + AST.prototype.re.lcChar + "]*)([" + AST.prototype.re.whitespace + AST.prototype.re.Pish + "]|\\.[" + AST.prototype.re.whitespace + "])");

    AST.prototype.re.protectedWords = RegExp("^(" + AST.prototype.re.protectedWord + ")((" + AST.prototype.re.wordJoiner + ")(" + AST.prototype.re.protectedWord + "))*");

    AST.prototype.re.unprotectedWord = RegExp("^" + AST.prototype.re.prefix + "+[" + AST.prototype.re.char + "]?");
    ...
    AST.prototype.start = function(name, attr, unary) {
      ...
      if (name === 'sc' || (tag.attr.style || '').match(/small-caps/i)) {
        tag.smallcaps = true;
      }
      if (tag["class"].nocase || name === 'nc') {
        tag.nocase = true;
      }
      if (tag.attr.relax != null) {
        tag.relax = true;
      }
